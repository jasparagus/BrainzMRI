...
class ActionConfirmDialog(tk.Toplevel):
    ...
    def __init__(self, parent, title, prompt):
        ...
        # Content
        lbl = tk.Label(self, text=prompt, wraplength=400, justify="left", font="AppFontLarge")
        ...
        btn_live = tk.Button(
            ...
            bg="#EF5350", fg="white", font="AppFontBold",
...
class ResolveConfirmDialog(tk.Toplevel):
    ...
    def __init__(self, parent, title, prompt):
        ...
        # Content
        lbl = tk.Label(self, text=prompt, wraplength=440, justify="left", font="AppFontLarge")
        lbl.pack(pady=20, padx=20, fill="x")
...
class ActionComponent:
    def __init__(self, parent: tk.Frame, app_state, table_view, on_update_callback, force_var: tk.BooleanVar = None, on_re_report_callback=None):
        ...
        # UI Elements
        tk.Label(self.frame, text="Actions:", bg="#ECEFF1", font="AppFontBold").pack(side="left", padx=10, pady=5)
