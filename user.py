...
class User:
    ...
    @classmethod
    def from_sources(cls, username: str, lastfm_username: str = "", listenbrainz_username: str = "", listenbrainz_token: str = "", listenbrainz_zips: list = None) -> "User":
        """
        Create a new User, initialize cache, and optionally ingest ZIPs.
        """
        user = cls(username, lastfm_username, listenbrainz_username, listenbrainz_token)
