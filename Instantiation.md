...
* **`gui_charts.py`:** Native Matplotlib window generation (Entity Trends for Artist/Track/Album, New Music, Genre Treemap, Likes for Days Treemaps, Album Art Matrix).
